...
(function(){
	...
	TCNDDU.setup = function () {
		...
		dropContainer = document.getElementById("img_upload");
	...
	TCNDDU.loadedXHR = function (event) {
		...
		alert("xhr upload of "+event.target.log.id+" complete");
	};
	...
	TCNDDU.processXHR = function (file, index) {
		...
		xhr.open("POST", "http://localhost/codeigniter/index.php/upload.php");
